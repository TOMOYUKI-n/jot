        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div>
                    ...
                    >Edit</router-link>
                    <a href="#"
                        class="px-4 py-2 text-red-500 border border-red-500 rounded text-sm font-bold"
                        @click="modal = !modal"
                    >Delete</a>
                    <div v-if="modal"
                        class="absolute bg-blue-900 text-white rounded-lg z-20 p-8 w-64
                        right-0 mt-2 mr-6"
                    >
            ...
            <p class="pt-6 text-gray-600 font-bold text-sm">Contact</p>
            <p class="pt-2 text-blue-400">{{ contact.email }}</p>

            <p class="pt-6 text-gray-600 font-bold text-sm">Company</p>
            <p class="pt-2 text-blue-400">{{ contact.company }}</p>

            <p class="pt-6 text-gray-600 font-bold text-sm">Birthday</p>
